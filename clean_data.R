...
dd_mini <- dd[,c("Город", "Зарплата.в.месяц", "Изменение.зарплаты.за.12.месяцев", "Должность", "Общий.опыт.работы", "Опыт.работы.на.текущем.месте", "Язык.программирования", "Специализация", "Возраст", "Пол", "Образование", "Университет", "Еще.студент", "Уровень.английского", "Размер.компании", "Тип.компании", "Предметная.область")]
minifile <- sub("final", "mini", outfile)
write.table(dd_mini, file=minifile, sep=",")
}

# outfile <- sub("raw", "final", infile)
source <- "data/2015_dec_raw.csv"
